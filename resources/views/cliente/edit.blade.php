            ...
            <form action="{{ route('cliente.update', $cliente) }}" method="POST">
                ...
                <div class="panel-body">
                    <div>
                        ...
                        <input class="field-input" type="text" name="nome" value="{{ old('nome', $cliente->nome) }}">
                        @error('nome') <p class="field-error">{{ $message }}</p> @enderror
                    </div>
                    <div class="field-grid">
                        <div>
                            <label class="field-label">CPF</label>
                            <input class="field-input" type="text" name="cpf" value="{{ old('cpf', $cliente->cpf) }}">
                            @error('cpf') <p class="field-error">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="field-label">Telefone</label>
                            <input class="field-input" type="text" name="telefone" value="{{ old('telefone', $cliente->telefone) }}">
                            @error('telefone') <p class="field-error">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    <div>
                        <label class="field-label">E-mail</label>
                        <input class="field-input" type="email" name="email" value="{{ old('email', $cliente->email) }}">
                ...
                <div class="panel-body">
                    <div class="field-grid">
                        <div>
                            ...
                            <input class="field-input" type="text" name="cep" value="{{ old('cep', $cliente->endereco->cep ?? '') }}">
                            @error('cep') <p class="field-error">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="field-label">Número</label>
                            <input class="field-input" type="text" name="numero" value="{{ old('numero', $cliente->endereco->numero ?? '') }}">
                            @error('numero') <p class="field-error">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    <div>
                        <label class="field-label">Rua</label>
                        <input class="field-input" type="text" name="rua" value="{{ old('rua', $cliente->endereco->rua ?? '') }}">
                        @error('rua') <p class="field-error">{{ $message }}</p> @enderror
                    </div>
                    <div class="field-grid">
                        <div>
                            <label class="field-label">Bairro</label>
                            <input class="field-input" type="text" name="bairro" value="{{ old('bairro', $cliente->endereco->bairro ?? '') }}">
                            @error('bairro') <p class="field-error">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="field-label">Cidade</label>
                            <input class="field-input" type="text" name="cidade" value="{{ old('cidade', $cliente->endereco->cidade ?? '') }}">
                            @error('cidade') <p class="field-error">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    <div style="max-width: 120px;">
                        <label class="field-label">UF</label>
                        <input class="field-input" type="text" name="uf" maxlength="2" value="{{ old('uf', $cliente->endereco->uf ?? '') }}">
                ...
                <div class="panel-footer">
                    ...
                    <a href="{{ route('cliente.show', $cliente->id) }}" class="btn-cancel">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
