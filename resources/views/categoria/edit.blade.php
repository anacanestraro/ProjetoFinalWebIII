...
<div class="form-page">
    <div class="form-wrap">
        <div class="form-header">
            ...
            <a href="{{ route('categoria.index') }}" class="form-back">
            ...
            <form action="{{ route('categoria.update', $categoria) }}" method="POST">
                ...
                <div class="panel-body">
                    <div>
                        ...
                        <input class="field-input" type="text" name="nome" value="{{ old('nome', $categoria->nome) }}">
                        @error('nome') <p class="field-error">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="field-label">Descrição</label>
                        <input class="field-input" type="text" name="descricao" value="{{ old('descricao', $categoria->descricao) }}">
                        @error('descricao') <p class="field-error">{{ $message }}</p> @enderror
                    </div>
                </div>
                <div class="panel-footer">
                    <button type="submit" class="btn-save">Salvar alterações</button>
                    <a href="{{ route('categoria.show', $categoria->id) }}" class="btn-cancel">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
