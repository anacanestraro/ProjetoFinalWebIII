...
<div class="form-page">
    <div class="form-wrap">
        <div class="form-header">
            <h1 class="form-title">Nova unidade</h1>
            ...
            <form action="{{ route('unidade.store') }}" method="POST">
                ...
                <div class="panel-body">
                    <div>
                        ...
                        <input class="field-input" type="text" name="sigla" value="{{ old('sigla') }}" autofocus>
                ...
                <div class="panel-footer">
                    ...
                    <a href="{{ route('unidade.index') }}" class="btn-cancel">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
